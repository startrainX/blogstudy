...
public class ZjArticlesController {
    ...
    /**
     * @GetMapping("/getPoliceCollectionDetail")
     * @ApiOperation(value = "警情采集详情数据", notes = "警情采集详情数据")
     * public HttpResult<Page<JhjjzdPoliceDetailInfoDTO>> getPoliceCollectionDetail(@ApiParam(value = "查询条件") PoliceCollectionQO qo) {
     * return HttpResult.success(jhjjzdPoliceDetailInfoService.getPoliceCollectionDetail(qo));
     * }
     */
